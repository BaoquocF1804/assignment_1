...
def main():
    ...
    pygame.font.init()
    pygame.mixer.init()
    pygame.mixer.music.load(os.path.join(os.path.dirname(os.path.realpath('Zombie.py')), 'Sounds/bensound-summer_ogg_music.ogg'))
    ...
    cursor_asset = pygame.image.load(os.path.join(os.path.dirname(os.path.realpath('Zombie.py')), 'Images/hammer.png'))
    ...
    font_score = pygame.font.Font(os.path.join(os.path.dirname(os.path.realpath('Zombie.py')), 'Fonts/pixel-gaming-font/PixelGamingRegular-d9w0g.ttf'), 35)
